...
# --dynamic_good=False --min_good=20.0 --max_bad=15.0 \
...
--seed=0 --num_training_step=60000000 \
--gamma=0.99 --cost_gamma=0.99 \
--number_layers=3 --hidden_units_actor=256 --hidden_units_critic=256 \
--coef_ent=0.0001 --reward_factor=1.0 --cost_limit=15.0 \
--lr_actor=0.0001 --lr_critic=0.0001 --lr_penalty=0.03 --clip_eps=0.2 \
--num_eval_episodes=100 --eval_num_envs=100 --max_grad_norm=1.0 \
--buffer_size=100000 --eval_interval=50000 --num_envs=10 --max_episode_length=500 \
--risk_level=1.0 --batch_size=4096 --epoch_disc=1000 \
--weight_path='./weights/SafetyDoggoCircle1-v0/SIM(100k)' \
--dynamic_good=True --min_good=17.0 --max_bad=12.0 \
--expert_path='./weights/SafetyDoggoCircle1-v0/PPO-unconstraint/s0-finish/actor.pth'
