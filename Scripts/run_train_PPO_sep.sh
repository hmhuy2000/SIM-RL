CUDA_VISIBLE_DEVICES=3 python Trains/train_PPO_sep.py \
...
--lr_actor=0.0001 --lr_critic=0.0001 --lr_penalty=1.0 --clip_eps=0.2 \
...
--weight_path='./weights/SafetyCarGoal1-v0/PPO-sep(25.0)' 